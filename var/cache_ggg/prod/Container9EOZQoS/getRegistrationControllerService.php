...
class getRegistrationControllerService extends App_KernelProdDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 3)))->fromStrings(['main' => $container->getEnv('MAILER_DSN')]), NULL, ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService())), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'))));
