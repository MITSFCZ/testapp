    ...
    <div class=\"row\" >
      <div class=\"col-xl-8 col-md-7 col-12\" style=\"margin-bottom: 15px\">
           ...
           <video width=\"100%\"  controls controlsList=\"nodownload\">
                ...
                <source src={{ \"https://d1jsawlrokhcmg.cloudfront.net/\" ~ video.video|replace({ ('+'): '/' }) | url_encode   }}   type=\"video/mp4\">
            </video> 
